...
export class AnnouncementController {
    ...
    async updateAnnouncement(@Body() body: { announcementId: string; updateData: any }) {
        const { announcementId, updateData } = body;
        return await this.announcementService.updateAnnouncement(announcementId, updateData);
    }
}
